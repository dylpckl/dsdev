...
function CaseStudyCard({ caseStudy }: { caseStudy: CaseStudy }) {
  ...
  return (
    ...
    <article className="flex flex-col max-w-4xl mx-auto group/card w-full group transition-all rounded-lg text-slate-200 bg-slate-700/50 shadow-xl ease-out duration-700 overflow-clip">
      ...
      <Link
        href="/"
        className="w-full bg-teal-300 text-teal-900 font-medium group/cta overflow-hidden h-0 group-hover:h-16 transition-all ease-in-out duration-500 flex items-center justify-center"
      >
