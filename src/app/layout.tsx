...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      >
        {/* Photo Credit */}
        <div className="absolute group h-6 w-6 rounded-full right-10 bg-slate-200/60 bottom-96">
          <div className="relative">
            <span className="absolute -top-7 right-10 bg-slate-500 opacity-0 transition-opacity group-hover:opacity-100 text-sm font-mono">
