  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          id="touchpoint"
          className="hidden md:block absolute group h-4 w-4 rounded-full right-10 md:right-4 bg-slate-100/60 outline outline-2 outline-offset-4 outline-slate-100/60 bottom-[40%] hover:bg-slate-100 transition-colors ease-out duration-500 hover:outline-slate-100"
        >
